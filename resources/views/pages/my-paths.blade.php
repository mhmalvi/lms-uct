            ...
            <div class="col-sm-4 card-group-row__col">
                ...
                <div class="card overlay--show card-lg overlay--primary-dodger-blue stack stack--1 card-group-row__card">
                    ...
                    <div class="card-body d-flex flex-column">
                        ...
                        <p class="mt-16pt text-70 flex">Angular is a platform for building mobile and desktop web applications.</p>
            ...
            <div class="col-sm-4 card-group-row__col">
                ...
                <div class="card card-lg overlay--primary-dodger-blue stack stack--1 card-group-row__card">
                    ...
                    <div class="card-body d-flex flex-column">
                        ...
                        <p class="mt-16pt text-70 flex">Swift is a powerful and intuitive programming language for macOS, iOS, watchOS, tvOS and beyond.</p>

                        <div class="mb-16pt d-none">
                            <div class="d-flex align-items-center">
                                <span class="material-icons icon-16pt text-50 mr-8pt">check</span>
                                <p class="flex text-50 lh-1 mb-0"><small>Fundamentals of working with Swift</small></p>
                            </div>
                            <div class="d-flex align-items-center">
                                <span class="material-icons icon-16pt text-50 mr-8pt">check</span>
                                <p class="flex text-50 lh-1 mb-0"><small>Create complete Swift applications</small></p>
                            </div>
                            <div class="d-flex align-items-center">
                                <span class="material-icons icon-16pt text-50 mr-8pt">check</span>
                                <p class="flex text-50 lh-1 mb-0"><small>Working with the Swift CLI</small></p>
                            </div>
                            <div class="d-flex align-items-center">
                                <span class="material-icons icon-16pt text-50 mr-8pt">check</span>
                                <p class="flex text-50 lh-1 mb-0"><small>Understanding Dependency Injection</small></p>
                            ...
                            <div class="d-flex align-items-center">
                                <span class="material-icons icon-16pt text-50 mr-8pt">check</span>
                                <p class="flex text-50 lh-1 mb-0"><small>Testing with Swift</small></p>
                            </div>
                        </div>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col text-right">
                                <a href="student-path.html"
                                    class="btn btn-outline-secondary">Begin</a>
                            </div>
                        </div>
            ...
            <div class="col-sm-4 card-group-row__col">
                ...
                <div class="card card-lg overlay--primary-dodger-blue stack stack--1 card-group-row__card">
                    ...
                    <div class="card-body d-flex flex-column">
                        ...
                        <p class="mt-16pt text-70 flex">WordPress is open source software you can use to create a beautiful website, blog, or app.</p>
