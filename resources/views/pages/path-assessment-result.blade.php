...
@section('content')
                        ...
                        <div class="ml-sm-auto order-sm-1">
                            <div class="position-relative overflow-hidden rounded border-4 border-light mb-16pt mb-sm-0">
                                <div class="bg-primary fullbleed"
                                        style="opacity: .5;"></div>
                                <img class=""
                                        src="/assets/images/paths/angular_96x96.png"
                                        alt="Angular">
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-6 mb-24pt mb-sm-0">
                    <div class="border-left-3 border-left-primary pl-24pt pl-md-32pt">
                        <h4 class="mb-8pt">Assessment details</h4>
                        <p class="text-70 mb-24pt mb-lg-0">Based on your skill level we recommend you take the Intermediate level Angular courses.</p>
                    </div>
                </div>
                <div class="col-lg-6 d-flex align-items-center">
                    <div class="page-num-timeline d-flex flex-column flex-sm-row align-items-center justify-content-center flex">
                        ...
                        <a href=""
                            data-toggle="tooltip"
                            data-placement="top"
                            data-title="Your current level: Intermediate"
    ...
    <div class="container page__container">
        <div class="border-left pl-32pt page-section">
                                ...
                                <div class="mdk-reveal__content">
                                    <div class="card-body">
                                        <div class="d-flex">
                                            <div class="flex">
                                                <a class="card-title"
                                                    href="student-course.html">Angular Services</a>
                                                <small class="text-50 font-weight-bold mb-4pt">Elijah Murray</small>
                                            </div>
                                            <a href="student-course.html"
                                                data-toggle="tooltip"
                                ...
                                <div class="mdk-reveal__content">
                                    <div class="card-body">
                                        <div class="d-flex">
                                            <div class="flex">
                                                <a class="card-title"
                                                    href="student-course.html">Angular Patterns</a>
                                                <small class="text-50 font-weight-bold mb-4pt">Elijah Murray</small>
                                            </div>
                                            <a href="student-course.html"
                                                data-toggle="tooltip"
            ...
            <div class="d-flex flex-column flex-sm-row flex-wrap align-items-center justify-content-center justify-content-sm-start mt-8pt">
                <a href="student-path.html"
                    class="btn btn-accent flex-auto mb-8pt mb-sm-0 mr-sm-16pt">Begin Angular Intermediate</a>
                <a href="student-path-assessment.html"
                    class="btn btn-outline-secondary flex-auto">Explore other Angular paths</a>
            </div>
        </div>
    </div>
@endsection
