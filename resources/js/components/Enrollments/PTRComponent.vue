<template>
  <div class="py-5">
    <h4 class="text-center">Pre-Training Review</h4>
    <div class="py-4">
      <div class="progress">
        <div
          class="progress-bar"
    ...
    <div class="py-3">
      ...
      <p>
        ...
        meets your individual needs. The pre-training review ensures:
      </p>
      <ul>
      ...
      <div class="pt-3">
        ...
        <p>
          Prior to completing Pre-Training Review, make sure you have sufficient
          information about the course. In particular, you must have access to
          the following information;
        </p>
        <ul>
          <li>
            Training and Assessment arrangements i.e. duration of the course,
            training and assessment modes, days of training, assessments to be
            completed
          </li>
          <li>
            Employment prospects - You should conduct your own research and have
            strong evidence of employability options on completion of the course
          </li>
          <li>
            Recognition of prior learning and credit transfer application
            process
          </li>
          <li>Fees and charges applicable for the training</li>
          <li>
            Your rights and obligations as a student at
            <strong>Unique College of Technology UCT</strong> - Entry
            requirements into the course
          </li>
        </ul>
      </div>
      <div class="pt-3">
        ...
        <p>
          Please ensure each question is answered as accurately as possible. If
          you require more space to write your response to a question please
      ...
      <div class="card-body">
        ...
        <div class="form-group">
          <label for="expectations"
            >What do you hope to gain from undertaking this
            qualification?</label
          >
          <textarea
            name="expectations"
    ...
    <div class="card">
      <div class="card-body">
        ...
        <div class="form-group">
          <label for="position"
            >Please write a brief description of your current position.</label
          >
          <textarea
            name="position"
            id="position"
        ...
        <div class="form-group pt-3">
          <label for="employed"
            >Provide your last 3 job titles and how long you were employed in
            each position.</label
          >
          <table class="table">
            <tbody>
    ...
    <div class="card">
      <div class="card-body">
        <div class="form-group">
          <label for="training1"
            >Have you acquired any formal training in any of the qualifications
    ...
    <div class="card">
      <div class="card-body">
        <div class="form-group">
          <label
            >Explain why it is important to read all signs in the workplace.
          </label>
          <textarea
            class="form-control"
    ...
    <div class="card">
      <div class="card-body">
        <div class="form-group">
          <label
            >Following information will help us to determine, you’re learning
            and styles and if we are able to deliver courses that meet your
            learning styles.
          </label>
          ...
          <div class="form-check">
            ...
            /><label class="form-check-label" for="support16"
              >Practical application of skills and knowledge in a workplace or
              similar or watching videos
            </label>
          </div>
          <div class="form-check">
            <input
          ...
          <div class="form-check">
            <input
              ...
              name="support1"
              id="support18"
            /><label class="form-check-label" for="support18">Other </label>
          </div>
        </div>
      </div>
    </div>
